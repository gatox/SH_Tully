...
#class Tully_3(Colt):
    ...
    def __init__(self, a,b,c):
        """ Tully model 3: Extended coupling with reflection 
    ...
    def from_config(cls,config):
        return cls(config['a'], config['b'], config['c'])
    ...
    def _di_gradient(self, x):
        ...
        D_11 = 0.0
        D_12 = self.c*self.b*np.exp(-self.c*np.abs(x))
...
#    HO = Tully_3(a = 0.0006, b = 0.10, c = 0.90)
...
a = SurfacePointProvider.from_questions(["energy"], 2, 1, config ="Tully3.in")

#a = Tully_3.from_questions(config = "values")
